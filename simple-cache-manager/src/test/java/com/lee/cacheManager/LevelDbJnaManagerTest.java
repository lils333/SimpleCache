...
import com.lee.cache.serializer.kryo.KryoJdkSerializer;
...
public class LevelDbJnaManagerTest {

    @Test
    public void testLevelDbJna() throws IOException {
        ...
        try {
            ...
            Cache<Integer, String> ehcacheManagerTest1 = cacheManager.getCache(
                    new LevelDbJnaConfiguration<>(Integer.class, String.class)
                            .name("LevelDbJnaManagerTest1")
                            .path(leveldbjni.getPath())
                            .cacheSize(8, CacheConfiguration.Unit.MB)
                            .writeBufferSize(4, CacheConfiguration.Unit.MB)
                            .createdIfMissing(true)
